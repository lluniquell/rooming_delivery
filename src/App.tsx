...
import SoumPicking from './pages/soum/SoumPicking'
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="soum/picking" element={driver && <RequirePermission perm="soum" driver={driver}><SoumPicking /></RequirePermission>} />
